...
class Bus(PublicTransport):
    def __init__(self, brand: str, engine_power: int, year: int, color: str,
                 max_speed: int, passengers: int, park: int, fare: int
                 ):
        """
        :param brand: Марка транспорта
        :param engine_power: Мощность двигателя
    ...
    def park(self, value: int):
        assert 999 < value < 10000
        self.__park = value


class Tram(PublicTransport):
    def __init__(self, brand: str, engine_power: int, year: int, color: str,
                 max_speed: int, route: int, path: int, fare: int
                 ):
        """
        :param brand: Марка транспорта
        :param engine_power: Мощность двигателя
